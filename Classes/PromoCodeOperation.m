...
- (id)initWithProduct:(Product *)aProduct numberOfCodes:(NSInteger)numberOfCodes
{
	...
	if (numberOfCodes == 0) {
		...
		self = [super initWithOperations:[NSArray arrayWithObjects:step1, step2, step3, step4, step5, step6, step7, step8, step9, nil]];
	} else {
		DownloadStepOperation *step9 = [DownloadStepOperation operationWithInput:step8];
		step9.startBlock = ^(DownloadStepOperation *operation) {
		...
		self = [super initWithOperations:[NSArray arrayWithObjects:step1, step2, step3, step4, step5, step6, step7, step8, step9, step10, step11, nil]];
	}
