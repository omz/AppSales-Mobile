...
//			
//			NSArray *downloadPaths = nil;//[historyPage componentsMatchedByRegex:@"<a href=\"(.*?)\".*?download-codes" capture:1];
//			NSArray *dateStrings = nil;//[historyPage componentsMatchedByRegex:@"<td>((Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)(.*?))</td>" capture:1];
//			
