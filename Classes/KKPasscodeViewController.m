...
#if defined(__IPHONE_7_0)
	if([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {
		size = [_failedAttemptsLabel.text sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14.0]}];
	}
	else {
#endif
		size = [_failedAttemptsLabel.text sizeWithFont:[UIFont systemFontOfSize:14.0]];
#if defined(__IPHONE_7_0)
	}
#endif
...
#endif
			size = [text sizeWithFont:[UIFont systemFontOfSize:14.0]];
#if defined(__IPHONE_7_0)
		}
#endif
