...
Support the development:
  ...
  <input type="hidden" name="business" value="YDQN4S3WVRCBU">
  <input type="hidden" name="lc" value="US">
  <input type="hidden" name="item_name" value="AppSales">
...
<a href="http://flattr.com/thing/366574/AppSales" target="_blank">
